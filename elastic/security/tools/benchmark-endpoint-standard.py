...
def main():
    ...
    with open(os.path.expanduser("~/.esbench/environments/bbbd2c1a-a835-4bac-852b-1147bf3b6be2/ansible/inventory-private-ip.yaml")) as file:
    ...
    if not included_suites or "simple" in included_suites:
        ...
        try:
            ...
            execute_command('ANSIBLE_CONFIG=ansible/ansible.cfg ansible-playbook -i ~/.esbench/environments/bbbd2c1a-a835-4bac-852b-1147bf3b6be2/ansible/inventory-private-ip.yaml ansible/playbooks/drop-caches.yml --extra-vars='"'"'{"is_teardown": false, "provider": "gcp"}'"'"' --extra-vars='"'"'{"load_driver_hosts":$load_driver_hosts}'"'"' --extra-vars='"'"'{"installation_id":$installation_id}'"'"'', {'load_driver_hosts': load_driver_hosts,'installation_id': installation_id,})
            execute_command('ANSIBLE_CONFIG=ansible/ansible.cfg ansible-playbook -i ~/.esbench/environments/bbbd2c1a-a835-4bac-852b-1147bf3b6be2/ansible/inventory-private-ip.yaml ansible/playbooks/trim-disks.yml --extra-vars='"'"'{"is_teardown": false, "provider": "gcp"}'"'"' --extra-vars='"'"'{"load_driver_hosts":$load_driver_hosts}'"'"' --extra-vars='"'"'{"installation_id":$installation_id}'"'"'', {'load_driver_hosts': load_driver_hosts,'installation_id': installation_id,})
            execute_command('ANSIBLE_CONFIG=ansible/ansible.cfg ansible-playbook -i ~/.esbench/environments/bbbd2c1a-a835-4bac-852b-1147bf3b6be2/ansible/inventory-private-ip.yaml ansible/playbooks/start-rallyd.yml --extra-vars='"'"'{"is_teardown": false, "provider": "gcp"}'"'"' --extra-vars='"'"'{"load_driver_hosts":$load_driver_hosts}'"'"' --extra-vars='"'"'{"installation_id":$installation_id}'"'"'', {'load_driver_hosts': load_driver_hosts,'installation_id': installation_id,})
            try:
                # Benchmark setup
                # referenced later by elasticsearch start fixture and esrally experiments
                race_id = uuid.uuid4()
                logger.info("Using race id: [%s].", race_id)
                execute_command('ANSIBLE_CONFIG=ansible/ansible.cfg ansible-playbook -i ~/.esbench/environments/bbbd2c1a-a835-4bac-852b-1147bf3b6be2/ansible/inventory-private-ip.yaml ansible/playbooks/wait-raid-recovery.yml --extra-vars='"'"'{"is_teardown": false, "provider": "gcp"}'"'"' --extra-vars='"'"'{"race_id":$race_id}'"'"' --extra-vars='"'"'{"load_driver_hosts":$load_driver_hosts}'"'"' --extra-vars='"'"'{"installation_id":$installation_id}'"'"'', {'race_id': race_id,'load_driver_hosts': load_driver_hosts,'installation_id': installation_id,})
                execute_command('ANSIBLE_CONFIG=ansible/ansible.cfg ansible-playbook -i ~/.esbench/environments/bbbd2c1a-a835-4bac-852b-1147bf3b6be2/ansible/inventory-private-ip.yaml ansible/playbooks/install-elasticsearch.yml --extra-vars='"'"'{"is_teardown": false, "provider": "gcp"}'"'"' --extra-vars='"'"'{"race_id":$race_id}'"'"' --extra-vars='"'"'{"load_driver_hosts":$load_driver_hosts}'"'"' --extra-vars='"'"'{"installation_id":$installation_id}'"'"'', {'race_id': race_id,'load_driver_hosts': load_driver_hosts,'installation_id': installation_id,})
                execute_command('ANSIBLE_CONFIG=ansible/ansible.cfg ansible-playbook -i ~/.esbench/environments/bbbd2c1a-a835-4bac-852b-1147bf3b6be2/ansible/inventory-private-ip.yaml ansible/playbooks/start-elasticsearch.yml --extra-vars='"'"'{"is_teardown": false, "telemetry": ["gc"], "telemetry_params": {}, "provider": "gcp"}'"'"' --extra-vars='"'"'{"race_id":$race_id}'"'"' --extra-vars='"'"'{"load_driver_hosts":$load_driver_hosts}'"'"' --extra-vars='"'"'{"installation_id":$installation_id}'"'"'', {'race_id': race_id,'load_driver_hosts': load_driver_hosts,'installation_id': installation_id,})
                execute_command('ANSIBLE_CONFIG=ansible/ansible.cfg ansible-playbook -i ~/.esbench/environments/bbbd2c1a-a835-4bac-852b-1147bf3b6be2/ansible/inventory-private-ip.yaml ansible/playbooks/start-metricbeat.yml --extra-vars='"'"'{"is_teardown": false, "provider": "gcp"}'"'"' --extra-vars='"'"'{"race_id":$race_id}'"'"' --extra-vars='"'"'{"load_driver_hosts":$load_driver_hosts}'"'"' --extra-vars='"'"'{"installation_id":$installation_id}'"'"'', {'race_id': race_id,'load_driver_hosts': load_driver_hosts,'installation_id': installation_id,})
                execute_command('ANSIBLE_CONFIG=ansible/ansible.cfg ansible-playbook -i ~/.esbench/environments/bbbd2c1a-a835-4bac-852b-1147bf3b6be2/ansible/inventory-private-ip.yaml ansible/playbooks/start-filebeat.yml --extra-vars='"'"'{"is_teardown": false, "provider": "gcp"}'"'"' --extra-vars='"'"'{"race_id":$race_id}'"'"' --extra-vars='"'"'{"load_driver_hosts":$load_driver_hosts}'"'"' --extra-vars='"'"'{"installation_id":$installation_id}'"'"'', {'race_id': race_id,'load_driver_hosts': load_driver_hosts,'installation_id': installation_id,})
                execute_command('ANSIBLE_CONFIG=ansible/ansible.cfg ansible-playbook -i ~/.esbench/environments/bbbd2c1a-a835-4bac-852b-1147bf3b6be2/ansible/inventory-private-ip.yaml ansible/playbooks/start-kibana.yml --extra-vars='"'"'{"is_teardown": false, "provider": "gcp"}'"'"' --extra-vars='"'"'{"race_id":$race_id}'"'"' --extra-vars='"'"'{"load_driver_hosts":$load_driver_hosts}'"'"' --extra-vars='"'"'{"installation_id":$installation_id}'"'"'', {'race_id': race_id,'load_driver_hosts': load_driver_hosts,'installation_id': installation_id,})
                # Benchmark experiment
                execute_command('esrally race --pipeline=benchmark-only --track-repository="achuguy" --track="elastic/security" --challenge="security-indexing" --on-error="abort" --target-hosts=~/.esbench/environments/bbbd2c1a-a835-4bac-852b-1147bf3b6be2/simple-experiment-0-target-hosts.json --client-options=~/.esbench/environments/bbbd2c1a-a835-4bac-852b-1147bf3b6be2/simple-experiment-0-client-options.json --track-params=~/track-params-endpoint-logsdb.json --telemetry-params=~/.esbench/environments/bbbd2c1a-a835-4bac-852b-1147bf3b6be2/simple-experiment-0-telemetry-params.json --user-tags=~/user-tags-endpoint-logsdb.json --race-id=$race_id --load-driver-hosts=$load_driver_hosts', {'race_id': race_id,'load_driver_hosts': load_driver_hosts,})
            finally:
                execute_command('ANSIBLE_CONFIG=ansible/ansible.cfg ansible-playbook -i ~/.esbench/environments/bbbd2c1a-a835-4bac-852b-1147bf3b6be2/ansible/inventory-private-ip.yaml ansible/playbooks/stop-kibana.yml --extra-vars='"'"'{"is_teardown": true, "provider": "gcp"}'"'"' --extra-vars='"'"'{"race_id":$race_id}'"'"' --extra-vars='"'"'{"load_driver_hosts":$load_driver_hosts}'"'"' --extra-vars='"'"'{"installation_id":$installation_id}'"'"'', {'race_id': race_id,'load_driver_hosts': load_driver_hosts,'installation_id': installation_id,})
                execute_command('ANSIBLE_CONFIG=ansible/ansible.cfg ansible-playbook -i ~/.esbench/environments/bbbd2c1a-a835-4bac-852b-1147bf3b6be2/ansible/inventory-private-ip.yaml ansible/playbooks/stop-elasticsearch.yml --extra-vars='"'"'{"is_teardown": true, "preserve_elasticsearch_install": true, "provider": "gcp"}'"'"' --extra-vars='"'"'{"race_id":$race_id}'"'"' --extra-vars='"'"'{"load_driver_hosts":$load_driver_hosts}'"'"' --extra-vars='"'"'{"installation_id":$installation_id}'"'"'', {'race_id': race_id,'load_driver_hosts': load_driver_hosts,'installation_id': installation_id,})
                execute_command('ANSIBLE_CONFIG=ansible/ansible.cfg ansible-playbook -i ~/.esbench/environments/bbbd2c1a-a835-4bac-852b-1147bf3b6be2/ansible/inventory-private-ip.yaml ansible/playbooks/stop-metricbeat.yml --extra-vars='"'"'{"is_teardown": true, "provider": "gcp"}'"'"' --extra-vars='"'"'{"race_id":$race_id}'"'"' --extra-vars='"'"'{"load_driver_hosts":$load_driver_hosts}'"'"' --extra-vars='"'"'{"installation_id":$installation_id}'"'"'', {'race_id': race_id,'load_driver_hosts': load_driver_hosts,'installation_id': installation_id,})
                execute_command('ANSIBLE_CONFIG=ansible/ansible.cfg ansible-playbook -i ~/.esbench/environments/bbbd2c1a-a835-4bac-852b-1147bf3b6be2/ansible/inventory-private-ip.yaml ansible/playbooks/stop-filebeat.yml --extra-vars='"'"'{"is_teardown": true, "provider": "gcp"}'"'"' --extra-vars='"'"'{"race_id":$race_id}'"'"' --extra-vars='"'"'{"load_driver_hosts":$load_driver_hosts}'"'"' --extra-vars='"'"'{"installation_id":$installation_id}'"'"'', {'race_id': race_id,'load_driver_hosts': load_driver_hosts,'installation_id': installation_id,})

        finally:
            execute_command('ANSIBLE_CONFIG=ansible/ansible.cfg ansible-playbook -i ~/.esbench/environments/bbbd2c1a-a835-4bac-852b-1147bf3b6be2/ansible/inventory-private-ip.yaml ansible/playbooks/stop-rallyd.yml --extra-vars='"'"'{"is_teardown": true, "provider": "gcp"}'"'"'', {})
