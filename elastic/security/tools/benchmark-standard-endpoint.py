    ...
    if not included_suites or "simple" in included_suites:
        ...
        try:
            ...
            try:
                ...
                execute_command('esrally race --track-repository=achuguy --pipeline=benchmark-only --track-repository="default" --track="elastic/security" --challenge="security-indexing" --on-error="abort" --target-hosts=~/.esbench/environments/2b61c966-3992-4077-9a3c-34c913087d16/simple-experiment-0-target-hosts.json --client-options=~/.esbench/environments/2b61c966-3992-4077-9a3c-34c913087d16/simple-experiment-0-client-options.json --track-params=~/track-params-standard-endpoint.json --telemetry-params=~/.esbench/environments/2b61c966-3992-4077-9a3c-34c913087d16/simple-experiment-0-telemetry-params.json --user-tags=~/user-tags-standard-endpoint.json --race-id=$race_id --load-driver-hosts=$load_driver_hosts', {'race_id': race_id,'load_driver_hosts': load_driver_hosts,})
            finally:
