...
def main():
    ...
    with open(os.path.expanduser("~/.esbench/environments/8ae8b342-ba76-4c2e-b376-573fdd9270ee/ansible/inventory-private-ip.yaml")) as file:
    ...
    if not included_suites or "simple" in included_suites:
        ...
        try:
            ...
            try:
                ...
                execute_command('esrally race --pipeline=benchmark-only --track-repository="achuguy" --track="elastic/security" --challenge="security-indexing" --on-error="abort" --target-hosts=~/.esbench/environments/8ae8b342-ba76-4c2e-b376-573fdd9270ee/simple-experiment-0-target-hosts.json --client-options=~/.esbench/environments/8ae8b342-ba76-4c2e-b376-573fdd9270ee/simple-experiment-0-client-options.json --track-params=~/track-params-siem-standard.json --telemetry-params=~/.esbench/environments/8ae8b342-ba76-4c2e-b376-573fdd9270ee/simple-experiment-0-telemetry-params.json --user-tags=~/user-tags-siem-standard.json --race-id=$race_id --load-driver-hosts=$load_driver_hosts', {'race_id': race_id,'load_driver_hosts': load_driver_hosts,})
            finally:
            ...
            execute_command('ANSIBLE_CONFIG=ansible/ansible.cfg ansible-playbook -i ~/.esbench/environments/8ae8b342-ba76-4c2e-b376-573fdd9270ee/ansible/inventory-private-ip.yaml ansible/playbooks/stop-rallyd.yml --extra-vars='"'"'{"is_teardown": true, "provider": "gcp"}'"'"'', {})
